...
console.log('Olá mundo, intrudoução a JS');
...
const alltrue = verdadeiro && !naoverdadeiro
const allfalse = !verdadeiro && naoverdadeiro
const firstrue = verdadeiro && naoverdadeiro
const secondtrue = !verdadeiro || !naoverdadeiro
